...
public class Constants {
	...
	public static final String MESSAGE_ID_EXIST = "La cédula ya existe en el sietema";
	public static final String MESSAGE_ID__NO_EXIST = "La cédula no existe en el sietema";
}